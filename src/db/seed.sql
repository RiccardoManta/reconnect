...
-- 1. platforms (IDs: 1='MQB', 2='MEB', 3='PPE')
INSERT INTO platforms (platform_name) VALUES
('MQB'),
('MEB'),
('PPE');

-- 2. user_groups (IDs: 1='Admin', 2='User', 3='MQB Editor')
INSERT INTO user_groups (user_group_name) VALUES
('Admin'),
('User'),
('MQB Editor');

-- 3. users (Assigning user_group_id, adding required email/password/salt)
...
-- 4. projects (Same as before - IDs: 1, 2, 3)
...
-- 5. software (Same as before - IDs: 1, 2, 3, 4, 5, 6)
...
-- 6. model_stands (Same as before - IDs: 1, 2, 3)
...
-- 7. vm_instances (Same as before - IDs: 1, 2, 3)
...
-- 8. test_benches (Same as before - IDs: 1, 2, 3)
...
-- 9. wetbenches (Same as before - IDs: 1, 2, 3) - Platform column here still string!
...
-- 10. pc_overview (Same as before - IDs: 1, 2, 3, 4)
...
-- 11. test_bench_project_overview (linking to bench_ids 1, 2, 3 using platform_id)
...
-- 12. hil_technology (Same as before - linking to bench_ids 1, 2, 3)
...
-- 13. hil_operation (Same as before - linking to bench_ids 1, 2, 3)
...
-- 14. hardware_installation (Same as before - linking to bench_ids 1, 2, 3)
...
-- 15. pc_software (Same as before - linking pc_ids 1,2,3,4 and software_ids 1-6)
...
-- 16. vm_software (Same as before - linking vm_ids 1,2,3 and software_ids 1-6)
...
-- 17. licenses (Same as before - IDs: 1, 2, 3 - using software_ids 1, 3, 5)
...
-- 18. license_assignments (Same as before - linking license_ids 1,2,3 and pc_ids/vm_ids)
...
-- 19. group_platform_access (Link groups to platforms)
-- Group IDs: 1='Admin', 2='User', 3='MQB Editor'
-- Platform IDs: 1='MQB', 2='MEB', 3='PPE'
INSERT INTO group_platform_access (user_group_id, platform_id) VALUES
(1, 1), -- Admin can access MQB
(1, 2), -- Admin can access MEB
(1, 3), -- Admin can access PPE
(2, 1), -- User can access MQB
(2, 2), -- User can access MEB (Example)
(3, 1); -- MQB Editor can access MQB 