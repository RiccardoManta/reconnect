...
// Seed sample data - make it async
async function seedDatabase() {
  try {
    ...
    `;
    await dbUtils.run(operationSql);
    ...
    // Closing handled in the main block
  }
}

// Run seeding if this script is executed directly - make wrapper async
if (require.main === module) {
  (async () => {
    try {
        ...
        // Close the pool after seeding is attempted
        await dbUtils.closePool();
        console.log("Seed script finished, pool closed.");
    }
  })();
}
